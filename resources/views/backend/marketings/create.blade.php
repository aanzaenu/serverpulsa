                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @if($errors->has('name')) is-invalid @endif" id="name"  name="name"  placeholder="A'an Zaenu Romli" value="{{ old('name') }}">                                    
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @if($errors->has('phone')) is-invalid @endif" id="phone"  name="phone"  placeholder="08562919141" value="{{ old('phone') }}">                                    
                                    @error('phone')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @if($errors->has('whatsapp')) is-invalid @endif" id="whatsapp"  name="whatsapp"  placeholder="+628562919141" value="{{ old('whatsapp') }}">                                    
                                    @error('whatsapp')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @if($errors->has('email')) is-invalid @endif" id="email"  name="email"  placeholder="aan.zaenu@gmail.com" value="{{ old('email') }}">                                    
                                    @error('email')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="lat" name="lat" class="form-control lat @if($errors->has('lat')) is-invalid @endif" placeholder="134" value="{{ old('lat') }}">
                                            @error('lat')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="long" name="long" class="form-control long @if($errors->has('long')) is-invalid @endif" placeholder="134" value="{{ old('long') }}">
                                            @error('long')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control @if($errors->has('address')) is-invalid @endif" id="address"  name="address"  placeholder="Jl.Cendrawasih No.148, Manukan, Condong Catur, Sleman, Yogyakarta" rows="3">{{ old('address') }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="card-box product-box p-0 mb-1 bg-dark @if($errors->has('image')) border border-danger rounded @endif">
                                        ...
                                        <div class="assets-image" style="background-image: url({{ old('image') }})"></div>
...
<script>
    $(document).ready(function(){
        ...
        var geocoder;
        var clat = {{ (!empty(old('lat'))) ? old('lat') : -3.421464 }};
        var clong = {{ (!empty(old('long'))) ? old('long') : 112.951445 }};
        var map = new google.maps.Map(document.getElementById('map'), {
            zoom: 5,
            center: new google.maps.LatLng(clat, clong),
            mapTypeId: google.maps.MapTypeId.ROADMAP
        });
        var rlat = {{ (!empty(old('lat'))) ? old('lat') : -7.781921 }};
        var rlong = {{ (!empty(old('long'))) ? old('long') : 110.364678 }};
        ...
        @if(!empty(old('lat')) && !empty(old('long')))
