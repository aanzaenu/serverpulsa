                ...
                <div class="col-sm-9">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select id="code_location" name="code_location" class="custom-select @if($errors->has('code_location')) is-invalid @endif" data-toggle="select2">
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->code_location }}" {{ ($branch->code_location == $row->code_location) ? 'selected' : '' }} >{{ $branch->code_location }}</option>
                                            @endforeach
                                        </select>
                                        @error('code_location')
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select id="code_type" name="code_type" class="custom-select @if($errors->has('code_type')) is-invalid @endif" data-toggle="select2">
                                            <option value="0" @if ($row->code_type == '0') selected @endif>KC</option>
                                            <option value="S" @if ($row->code_type == 'S') selected @endif>KCS</option>
                                            <option value="K" @if ($row->code_type == 'K') selected @endif>KCK</option>
                                            <option value="P" @if ($row->code_type == 'P') selected @endif>KCP</option>
                                            <option value="C" @if ($row->code_type == 'C') selected @endif>KCC</option>
                                        </select>
                                        @error('code_type')
                                            <div class="invalid-feedback" role="feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group col-md-4 @if($errors->has('code_year')) is-invalid @endif">
                                        ...
                                        <div class="input-group @if($errors->has('code_year')) is-invalid @endif">
                                            ...
                                            <input type="text" class="form-control @if($errors->has('code_year')) is-invalid @endif" id="code_year" name="code_year" placeholder="10" value="{{ $row->code_year }}">
                                        </div>                                        
                                        @error('code_year')
                                            <div class="invalid-feedback" role="feedback">
                                                {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="asset_type" name="asset_type" class="custom-select @if($errors->has('asset_type')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        <option value="Konsumer" @if ($row->asset_type == 'Konsumer') selected @endif>Konsumer</option>
                                        <option value="Komersil" @if ($row->asset_type == 'Komersil') selected @endif>Komersil</option>
                                        <option value="Pasif" @if ($row->asset_type == 'Pasif') selected @endif>Pasif</option>
                                        <option value="Syariah" @if ($row->asset_type == 'Syariah') selected @endif>Syariah</option>
                                    </select>
                                    @error('asset_type')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rec" name="rec" class="form-control @if($errors->has('rec')) is-invalid @endif" placeholder="9999999999" value="{{ $row->rec }}">
                                    @error('rec')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="price" name="price" class="form-control @if($errors->has('price')) is-invalid @endif" placeholder="100.000.000" value="{{ $row->price }}" data-toggle="input-mask" data-mask-format="000.000.000.000.000" data-reverse="true" />
                                                @error('price')
                                                    <div class="invalid-feedback" role="feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="price_sale" name="price_sale" class="form-control @if($errors->has('price_sale')) is-invalid @endif" placeholder="99.999.999" value="{{ $row->price_sale }}" data-toggle="input-mask" data-mask-format="000.000.000.000.000" data-reverse="true" />
                                                @error('price_sale')
                                                    <div class="invalid-feedback" role="feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="house_category" name="house_category" class="custom-select @if($errors->has('house_category')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if (count($row->categories()->get()) !== 0) @if ($row->categories()->first()->id == $category->id) selected @endif @endif>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="house_type" name="house_type" class="custom-select @if($errors->has('house_type')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        <option value="21" @if ($row->house_type == 21) selected @endif>21</option>
                                        <option value="27" @if ($row->house_type == 27) selected @endif>27</option>
                                        <option value="36" @if ($row->house_type == 36) selected @endif>36</option>
                                        <option value="45" @if ($row->house_type == 45) selected @endif>45</option>
                                        <option value="70" @if ($row->house_type == 70) selected @endif>70</option>
                                        <option value="90" @if ($row->house_type == 90) selected @endif>90</option>
                                        <option value="115" @if ($row->house_type == 115) selected @endif>115</option>
                                        <option value="135" @if ($row->house_type == 135) selected @endif>135</option>
                                        <option value="175" @if ($row->house_type == 175) selected @endif>175</option>
                                    </select>
                                    @error('house_type')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="house_street" name="house_street" class="form-control @if($errors->has('house_street')) is-invalid @endif" placeholder="50" value="{{ $row->house_street }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="house_wide" name="house_wide" class="form-control @if($errors->has('house_wide')) is-invalid @endif" placeholder="50" data-toggle="input-mask" data-mask-format="000.000.000.000.000" data-reverse="true" value="{{ $row->house_wide }}">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                M²
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="house_building" name="house_building" class="form-control @if($errors->has('house_building')) is-invalid @endif" placeholder="50" data-toggle="input-mask" data-mask-format="000.000.000.000.000" data-reverse="true" value="{{ $row->house_building }}">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                M²
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="doc_type" name="doc_type" class="custom-select @if($errors->has('doc_type')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        <option value="SHM" @if ($row->doc_type == 'SHM') selected @endif>SHM</option>
                                        <option value="SHGB" @if ($row->doc_type == 'SHGB') selected @endif>SHGB</option>
                                        <option value="SHGP" @if ($row->doc_type == 'SHGP') selected @endif>SHGP</option>
                                        <option value="HPL" @if ($row->doc_type == 'HPL') selected @endif>HPL</option>
                                        <option value="HGU" @if ($row->doc_type == 'HGU') selected @endif>HGU</option>
                                    </select>
                                    @error('doc_type')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="doc_no" name="doc_no" class="form-control @if($errors->has('doc_no')) is-invalid @endif" placeholder="025" value="{{ $row->doc_no }}">
                                        @error('doc_no')
                                            <div class="invalid-feedback" role="feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="doc_name" name="doc_name" class="form-control @if($errors->has('doc_name')) is-invalid @endif" placeholder="Aan Zaenu Romli" value="{{ $row->doc_name }}">
                                        @error('doc_name')
                                            <div class="invalid-feedback" role="feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="sales" name="sales" class="custom-select @if($errors->has('sales')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        @foreach ($marketings as $sales)
                                            <option value="{{ $sales->id }}" {{ ($row->sales == $sales->id) ? 'selected' : '' }}>{{ $sales->name.' - '.$sales->branches()->first()->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('sales')
                                        <div class="invalid-feedback" role="feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="branch" name="branch" class="custom-select @if($errors->has('branch')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}" @if ($row->branches()) {{ ($row->branches()->first()->id == $branch->id) ? 'selected' : '' }} @endif>{{ $branch->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('branch')
                                        <div class="invalid-feedback" role="feedback">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="sold_method" name="sold_method" class="custom-select @if($errors->has('sold_method')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        <option value="1" @if ($row->sold_method == 1) selected @endif>Penjualan Langsung</option>
                                        <option value="2" @if ($row->sold_method == 2) selected @endif>Lelang</option>
                                    </select>
                                    @error('sold_method')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                ...
                                <div class="penjualan-langsung @if (!empty($row->sold_method) && $row->sold_method == 1) @else d-none @endif">
                                    <div class="form-group">
                                        ...
                                        <select id="bank_location" name="bank_location" class="custom-select @if($errors->has('bank_location')) is-invalid @endif" data-toggle="select2">
                                            <option value="">Pilih Kantor Cabang</option>
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}" {{ ($row->bank_location == $branch->id) ? 'selected' : '' }}>{{ $branch->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('bank_location')
                                            <div class="invalid-feedback" role="feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="sold_note" name="sold_note" class="custom-select @if($errors->has('sold_note')) is-invalid @endif" data-toggle="select2">
                                            ...
                                            <option value="1" @if ($row->sold_note == 1) selected @endif>CESSIE</option>
                                            <option value="2" @if ($row->sold_note == 2) selected @endif>SKM</option>
                                            <option value="3" @if ($row->sold_note == 3) selected @endif>Penjualan Bersama</option>
                                            <option value="4" @if ($row->sold_note == 4) selected @endif>Lainnya</option>
                                        </select>
                                        @error('sold_note')
                                            <div class="invalid-feedback" role="feedback">
                                                {{ $message }}
                                ...
                                <div class="lelang @if (!empty($row->sold_method) && $row->sold_method == 2) @else d-none @endif">
                                    <div class="form-group">
                                        ...
                                        <select id="auction_location" name="auction_location" class="custom-select @if($errors->has('auction_location')) is-invalid @endif" data-toggle="select2">
                                            ...
                                            @foreach ($kpknl as $kpk)
                                                <option value="{{ $kpk->id }}" {{ ($row->auction_location == $kpk->id) ? 'selected' : '' }}>{{ $kpk->name.' - '.$kpk->address }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="auction_time" name="auction_time" class="form-control @if($errors->has('auction_time')) is-invalid @endif" placeholder="2020-10-05 12:12:00" value="{{ $row->auction_time }}" data-toggle="waktu">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" name="address" class="form-control @if($errors->has('address')) is-invalid @endif" placeholder="Jl.Cendrawasih No.148, Manukan, Condong Catur, Sleman, Yogyakarta" value="{{ $row->address }}">
                                    @error('address')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address_no" name="address_no" class="form-control @if($errors->has('address_no')) is-invalid @endif" placeholder="134" value="{{ $row->address_no }}">
                                    @error('address_no')
                                        <div class="invalid-feedback" role="feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address_rt" name="address_rt" class="form-control @if($errors->has('address_rt')) is-invalid @endif" placeholder="134" value="{{ $row->address_rt }}">
                                            @error('address_rt')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address_rw" name="address_rw" class="form-control @if($errors->has('address_rw')) is-invalid @endif" placeholder="15" value="{{ $row->address_rw }}">
                                            @error('address_rw')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="address_prov" name="address_prov" class="custom-select @if($errors->has('address_prov')) is-invalid @endif" data-toggle="select2">
                                        ...
                                        @foreach ($provinsi as $prov)
                                            <option value="{{ $prov->code }}" @if ($row->address_prov == $prov->code) selected @endif>{{ $prov->name }}</option>
                                        @endforeach                                        
                                    </select>
                                    @error('address_prov')
                                        <div class="invalid-feedback" role="feedback">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">                                        
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address_lat" name="address_lat" class="form-control lat @if($errors->has('address_lat')) is-invalid @endif" placeholder="134" value="{{ $row->address_lat }}">
                                            @error('address_lat')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address_long" name="address_long" class="form-control long @if($errors->has('address_long')) is-invalid @endif" placeholder="134" value="{{ $row->address_long }}">
                                            @error('address_long')
                                                <div class="invalid-feedback" role="feedback">
                                                    {{ $message }}
                                                </div>
                    ...
                    <div class="card-box">
                        ...
                        <div class="row container-image">
                            @if (count($row->medias()->get()) > 0)
                                @foreach ($row->medias()->get() as $key=>$item)
                                    <div class="col-md-6 col-xl-3 list-images">
                                        <div class="card-box product-box p-0 bg-dark @if($errors->has('image.'.$key)) border border-danger rounded @endif">
                                            <div class="product-action">
                                                <button type="button" class="btn btn-amdbtn btn-xs waves-effect waves-light ajax-delete-image" data-id="{{ $item->id }}">
                                                    <i class="mdi mdi-close"></i>
                                                </button>
                                            </div>
                                            <div class="assets-image" style="background-image: url({{ asset($item->path) }})">
                                            </div>
                                        </div>
                                    </div>                                    
                                @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="publish" name="publish" class="custom-select">
                                        <option value="0" @if ($row->publish == 0) selected @endif>Tidak</option>
                                        <option value="1" @if ($row->publish == 1) selected @endif>Ya</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="status">Status</label>
                                    <select name="status" class="custom-select">
                                        <option value="0" @if ($row->status == 0) selected @endif>OPEN</option>
                                        <option value="1" @if ($row->status == 1) selected @endif>TERJUAL</option>
                                        <option value="2" @if ($row->status == 2) selected @endif>PENDING (OPEN)</option>
                                        <option value="3" @if ($row->status == 3) selected @endif>PENDING (TERJUAL)</option>
                                        <option value="4" @if ($row->status == 4) selected @endif>REJECT</option>
                                        <option value="5" @if ($row->status == 5) selected @endif>RESTRUK</option>
                                    </select>
                                </div>
...
<script>
    $(document).ready(function(){
        ...
        @if (!empty($row->address_prov) && empty($row->address_kab))
            var v = "{{ $row->address_prov }}";
            var arr = {
                'from': 'prov',
                'val': v
            };
        ...
        @endif
        @if (!empty($row->address_kab))
            var v = "{{ $row->address_prov }}";
            var sel = "{{ $row->address_kab }}";
            var arr = {
                'from': 'prov',
                'val': v,
                'sel': sel
        ...
        @endif
        @if (!empty($row->address_kec))
            var v = "{{ $row->address_kab }}";
            var sel = "{{ $row->address_kec }}";
            var arr = {
                'from': 'kab',
                'val': v,
                'sel': sel
        ...
        $('.ajax-delete-image').on('click', function(){
            var id = $(this).data('id');
            var parent = $(this).closest('.list-images');
            var data = {
                '_token': $('input[name="_token"]').val(),
            ...
            $.ajax({
                type: 'POST',
                data: data,
                url: "{{ route('admin.'.$uri.'.ajaxdeleteimage') }}",
                success: function(response){
                    if(response.status)
                    {
                        parent.remove();
        ...
        var geocoder;
        var clat = {{ (!empty($row->address_lat)) ? $row->address_lat : -3.421464 }};
        var clong = {{ (!empty($row->address_long)) ? $row->address_long : 112.951445 }};
        var map = new google.maps.Map(document.getElementById('map'), {
            zoom: 5,
            center: new google.maps.LatLng(clat, clong),
            mapTypeId: google.maps.MapTypeId.ROADMAP
        });
        var rlat = {{ (!empty($row->address_lat)) ? $row->address_lat : -7.781921 }};
        var rlong = {{ (!empty($row->address_long)) ? $row->address_long : 110.364678 }};
        ...
        @if(!empty($row->address_lat) && !empty($row->address_long))
