                        ...
                        <table class="table mytable table-hover mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sorting @if($order_by =='djkn_name') @if($order == 'asc') sorting_asc @else sorting_desc @endif @endif">
                                        <a class="text-dark" href="{{ route('admin.'.$uri.'.search').'?'.$kueri.'orderby=djkn_name&order='.$urut }}">
                                            Nama DJKN
                                        </a>
                                    </th>
                                    <th class="sorting @if($order_by =='djkn_id') @if($order == 'asc') sorting_asc @else sorting_desc @endif @endif">
                                        <a class="text-dark" href="{{ route('admin.'.$uri.'.search').'?'.$kueri.'orderby=djkn_id&order='.$urut }}">
                                            ID DJKN
                                        </a>
                                    </th>
                                    <th class="sorting @if($order_by =='phone') @if($order == 'asc') sorting_asc @else sorting_desc @endif @endif">
                                        <a class="text-dark" href="{{ route('admin.'.$uri.'.search').'?'.$kueri.'orderby=phone&order='.$urut }}">
                                            Nomor Telepon
                                        </a>
                                    </th>
                                    <th class="sorting @if($order_by =='fax') @if($order == 'asc') sorting_asc @else sorting_desc @endif @endif">
                                        <a class="text-dark" href="{{ route('admin.'.$uri.'.search').'?'.$kueri.'orderby=fax&order='.$urut }}">
                                            Fax
                                        </a>
                                    </th>
                                    <th class="sorting @if($order_by =='address') @if($order == 'asc') sorting_asc @else sorting_desc @endif @endif">
                                        <a class="text-dark" href="{{ route('admin.'.$uri.'.search').'?'.$kueri.'orderby=address&order='.$urut }}">
                                            Alamat
                                        </a>
                                    </th>
                                    <th>Aksi</th>
